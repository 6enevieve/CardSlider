...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let opportunityCard = ImageCard(frame: CGRect(x: 0, y: 0, width: self.view.frame.width - 60, height: self.view.frame.height * 0.6), image: #imageLiteral(resourceName: "curiosity_earth"), name: "Opportunity", description: "I like a lot of things you probably haven't heard of.")
